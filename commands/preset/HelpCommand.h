...
namespace commands::preset {
    ...
    public:
        ...
        void execute(data::Context& ctx, const std::string&) override {
            ...
            ctx.out << "  preset load [file]              Replace in-memory presets from a .ptzc file (default: presets.ptzc)\n";
            ctx.out << "  preset save [file]              Save current presets to a .ptzc file (default: presets.ptzc)\n";
        }
    };
}
